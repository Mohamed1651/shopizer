...
public class SchemaConstant {
	...
	private static final String NEW_ZEALAND_DOLLAR = "New Zealand Dollar";
	private static final String CFA_FRANC_BEAC = "CFA Franc BEAC";
	private static final String EAST_CARIBBEAN_DOLLAR = "East Caribbean Dollar";
	private static final String AUSTRALIAN_DOLLAR = "Australian Dollar";
	private static final String CFP_FRANC = "CFP Franc";
	private static final String NORWEGIAN_KRONE = "Norwegian Krone";
	private static final String POUND_STERLING = "Pound Sterling";
	private static final String CFA_FRANC_BCEAO = "CFA Franc BCEAO";
	/**
	 * Languages iso codes
	 * 
	 */
	...
	static {
		...
		CURRENCY_MAP.put("XOF", CFA_FRANC_BCEAO);
		...
		CURRENCY_MAP.put("NOK", NORWEGIAN_KRONE);
		...
		CURRENCY_MAP.put("XAF", CFA_FRANC_BEAC);
		...
		CURRENCY_MAP.put("NZD", NEW_ZEALAND_DOLLAR);
		...
		CURRENCY_MAP.put("DKK", DANISH_KRONE);
		...
		CURRENCY_MAP.put("XPF", CFP_FRANC);
		CURRENCY_MAP.put("XAF", CFA_FRANC_BEAC);
		...
		CURRENCY_MAP.put("GBP", POUND_STERLING);
